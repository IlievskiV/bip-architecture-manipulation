package ch.epfl.risd.archman.z3;
...
class JavaExample {
	...
	public void floatingPointExample1(Context ctx) throws TestFailedException {
		...
		FPNum z = (FPNum) ctx.mkNumeral("-1.25p3",
				s); /* -1.25 * 2^3 = -1.25 * 8 = -10 */
		...
		/*
		 * nothing is equal to NaN according to floating-point equality, so NaN
		 * == k should be unsatisfiable.
		 */
